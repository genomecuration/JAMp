...
typedef struct context_struct
{
  ...
  wn_bool (*pterminate)(double vect[],double best_f);
...
local wn_bool default_terminate(double vect[],double best_f)
{
  return(FALSE);
}
...
local wn_bool my_wolfe_condition_satisfied(double x0,double f0,double df0,
				        double xs,double fs,double dfs)
{
